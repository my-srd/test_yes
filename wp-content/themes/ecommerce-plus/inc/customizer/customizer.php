...
function ecommerce_plus_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'ecommerce_plus_options[header_txt_logo_extra]', array(
		...
		'choices'			=> array( 
								...
								'tagline-only' => esc_html__( 'Tagline Only', 'ecommerce-plus' ),
								'logo-title'   => esc_html__( 'Logo and Title', 'ecommerce-plus' ),
								'logo-tagline' => esc_html__( 'Logo and Tagline', 'ecommerce-plus' ),
			)
	) );
	...
	// load home template options
	require get_template_directory() . '/inc/customizer/home-page-options/services.php';	
...
if ( ! function_exists( 'ecommerce_plus_is_breadcrumb_enable' ) ) :
	...
	function ecommerce_plus_is_breadcrumb_enable( $control ) {
		return $control->manager->get_setting( 'ecommerce_plus_options[breadcrumb_enable]' )->value();
	}
endif;
...
function ecommerce_plus_home_sections(){
	$sections = array(	''									=> esc_html__('--None--', 'ecommerce-plus'),
						...
						'ecommerce_plus_services' 			=> esc_html__('Services', 'ecommerce-plus'),
						'ecommerce_plus_product_slider' 	=> esc_html__('Product Slider 1', 'ecommerce-plus'),
						'ecommerce_plus_product_slider_2' 	=> esc_html__('Product Slider 2', 'ecommerce-plus'),
