...
$products_view = lorada_get_opt('grouped_product_position');

do_action( 'woocommerce_before_add_to_cart_form' ); ?>

<?php if ( 'after_summary' == $products_view ) : ?>
	<h2 class="grouped-form-title"><?php echo esc_html( 'Grouped Products', 'lorada' ); ?></h2>
<?php endif; ?>

<form class="cart grouped_form <?php echo esc_attr( $products_view ) ?>-position" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
